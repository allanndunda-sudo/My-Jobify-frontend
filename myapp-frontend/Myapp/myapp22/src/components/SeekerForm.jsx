...
//     if (currentSkill.trim() && !profile.skills.includes(currentSkill)) {
...
//             className="w-full border rounded px-3 py-2"
//           />
//           <button type="button" onClick={handleAddSkill} className="bg-blue-600 text-white px-3 py-2 rounded">
//             Add
//           </button>
//         </div>
...
//               {skill}
//               <button type="button" onClick={() => handleRemoveSkill(skill)} className="ml-2 text-red-500">x</button>
//             </span>
//           ))}
//         </div>
//       </div>
...
//       <input
//         type="text"
//         placeholder="Education Level (e.g., Bachelor's)"
